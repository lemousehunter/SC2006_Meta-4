...
const BottomBarComponent = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  ...
  const d = type === 'DOWN' ? (0, _pathDown.getPathDown)(maxWidth, getTabbarHeight, getCircleWidth, borderTopLeftRight, circlePosition) : (0, _pathUp.getPathUp)(maxWidth, getTabbarHeight + 30, getCircleWidth, borderTopLeftRight, circlePosition);
  ...
  const _renderTabIcon = (arr, focusedTab, navigation) => {
  ...
  const _renderTabContainer = props => {
    return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
