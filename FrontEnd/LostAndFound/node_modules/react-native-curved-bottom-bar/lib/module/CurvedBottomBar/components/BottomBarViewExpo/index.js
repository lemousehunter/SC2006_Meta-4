...
const BottomBarComponent = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  const d = type === 'DOWN' ? getPathDown(maxWidth, getTabbarHeight, getCircleWidth, borderTopLeftRight, circlePosition) : getPathUp(maxWidth, getTabbarHeight + 30, getCircleWidth, borderTopLeftRight, circlePosition);
